...
const char helpStr27[] = "Busy message..: AT$BM=busy message";
const char helpStr28[] = "mDNS name.....: AT$MDNS=mDNS name";
const char helpStr29[] = "WiFi password.: AT$PASS=WiFi password";
const char helpStr30[] = "Serial speed..: AT$SB=n";
const char helpStr31[] = "Server port...: AT$SP=n";
const char helpStr32[] = "WiFi SSID.....: AT$SSID=ssid";
const char helpStr33[] = "Data config...: AT$SU=dps";
const char helpStr34[] = "Location......: AT$TTL=telnet location";
const char helpStr35[] = "Terminal size.: AT$TTS=WxH";
const char helpStr36[] = "Terminal type.: AT$TTY=terminal type";
const char helpStr37[] = "Startup wait..: AT$W=n";
const char helpStr38[] = "";
